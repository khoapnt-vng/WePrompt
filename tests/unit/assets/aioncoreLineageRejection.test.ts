...
const INDEPENDENT_ACCEPTED_LINEAGE: Lineage = {
  ...
  latestVersion: 29,
  entryCount: 29,
  fingerprint: '5bfe0786fe7010ca3ae87638617c0bcf72572e010a166b65cbf5e37304057a82',
  entries: [
    {
      version: 1,
    ...
    },
    {
      ...
      filename: '002_legacy_data_normalize.sql',
    ...
    },
    {
      ...
      filename: '003_agent_acp_capabilities.sql',
    ...
    },
    {
      ...
      filename: '004_update_bun_agent_package_versions.sql',
    ...
    },
    {
      ...
      filename: '005_fix_real_timestamps.sql',
    ...
    },
    {
      ...
      filename: '006_provider_is_full_url.sql',
    ...
    },
    {
      ...
      filename: '007_mcp_soft_delete.sql',
    ...
    },
    {
      ...
      filename: '008_builtin_acp_agents_use_npx.sql',
    ...
    },
    {
      ...
      filename: '009_builtin_managed_acp_tools.sql',
    ...
    },
    {
      ...
      filename: '010_hermes_yolo_id_null.sql',
    ...
    },
    {
      ...
      filename: '011_add_openclaw_acp_agent.sql',
    ...
    },
    {
      ...
      filename: '012_assistant_data_unification.sql',
    ...
    },
    {
      ...
      filename: '015_aionrs_mode_catalog.sql',
    ...
    },
    {
      ...
      filename: '016_clear_internal_aion_cli_command_override.sql',
    ...
    },
    {
      ...
      filename: '017_drop_conversation_assistant_identity_snapshot.sql',
    ...
    },
    {
      ...
      filename: '018_reset_builtin_assistant_enabled.sql',
    ...
    },
    {
      ...
      filename: '019_assistant_thought_level_defaults.sql',
    ...
    },
    {
      ...
      filename: '020_update_codex_acp_package_scope.sql',
    ...
    },
    {
      ...
      filename: '021_codex_agent_full_access_yolo_id.sql',
    ...
    },
    {
      ...
      filename: '022_cron_execution_dedup.sql',
    ...
    },
    {
      ...
      filename: '023_add_pi_builtin_acp_agent.sql',
    ...
    },
    {
      ...
      filename: '024_drop_unused_assistant_definition_fields.sql',
    ...
    },
    {
      ...
      filename: '025_sync_and_add_acp_registry_agents.sql',
    ...
    },
    {
      ...
      filename: '026_clear_bridge_agent_command_override.sql',
    ...
    },
    {
      ...
      filename: '027_provider_model_settings.sql',
    ...
    },
    {
      ...
      checksum: 'd7deb7bd13c8654bf04671e7588167ee0006cadf4760ac903bfd6ff6976e92b5736bd8157c7acc5416687b30abbe0ca7',
    },
    {
      version: 29,
      description: 'verified session mcp trust',
      filename: '029_verified_session_mcp_trust.sql',
      checksum: 'e55424b84033ebf5171bc6ccb96d2c6e5edd27d38c736bde96862a30ceeb7a776a243cee1a1d6b9e89ed1ee337937753',
    },
  ],
};
...
function legacyFixtureContract() {
  return {
    repository: 'khoapnt-vng/aioncore',
    expectedSourceCommit: 'ef6e1dd199e884fdf2df95d494b2c51b97006656',
    expectedLineage: INDEPENDENT_ACCEPTED_LINEAGE,
    allowedRuntimeKeys: ['darwin-arm64'],
...
const LINEAGE_MUTATIONS: Array<[string, (lineage: Lineage) => void]> = [
  ...
  [
    ...
    (lineage) =>
      lineage.entries.push({
        ...
        filename: '030_deliberately_extra_migration.sql',
  ...
  ['a changed latest version', (lineage) => (lineage.latestVersion = 30)],
