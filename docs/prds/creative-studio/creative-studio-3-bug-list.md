...
- [ ] **[BUG-122][P1][Creative Studio] A project cannot add a newly discovered background after approving its character references** — found 2026-08-25 in the owner-driven real-model run on `3ac63eb9f`
...
- [ ] **[BUG-123][P1][Creative Studio] An imported first frame is labelled current, then Pin fails as a storage error while an authorized video waits** — found 2026-08-25 in the same real-model run on `3ac63eb9f`
