...
- [ ] **[BUG-117][P1][Creative Studio] The Beat panel goes blind for the whole duration of a render, because three non-atomic reads are compared for exact equality** — diagnosed 2026-08-23
...
- [ ] **[BUG-119][P1][Creative Studio] A single `.DS_Store` permanently kills every export in a project, and opening an export folder is what creates it** — found and root-caused 2026-08-23
