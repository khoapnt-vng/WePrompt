...
**122 bugs filed · 119 closed · 3 open** — all P1. **BUG-182** is the live blocker: the Director cannot storyboard a film that ends on an end card. **BUG-144** (ffmpeg distribution) and **BUG-165** (whether a chained take's quoted upper bound may double to pay for a retry) are blocked on an owner decision rather than on engineering.
