...
**123 bugs filed · 119 closed · 4 open** — **BUG-182** (P1) is the live blocker: the Director cannot storyboard a film that ends on an end card. **BUG-183** (P2) is the message class the owner kept hitting beside it: blocking banners that name a control without locating it. **BUG-144** and **BUG-165** (both P1) are blocked on an owner decision rather than on engineering.
