...
**121 bugs filed · 119 closed · 2 open** — both P1, and both blocked on an owner decision rather than on engineering: **BUG-144** (ffmpeg distribution) and **BUG-165** (whether a chained take's quoted upper bound may double to pay for a retry).
