...
const creativeStudioRuntimeManifest = [
  ...
  'packages/desktop/src/process/services/creative-studio/service/schema2/references/index.ts',
  ...
  'packages/desktop/src/renderer/pages/studio/components/Shell/DirectorProposalCard/proposalReview.ts',
  ...
  'packages/desktop/src/renderer/pages/studio/components/Workspace/Views/Table/lookFold.ts',
