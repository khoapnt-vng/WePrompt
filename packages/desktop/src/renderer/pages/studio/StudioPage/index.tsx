...
import {
  useStudioDirectorToolOutcomeInterpreter,
  useStudioGeneratedReferenceReview,
  useStudioHandoffDismissal,
  useStudioPaidRecoveryProposalState,
  useStudioProposalCardActions,
  useStudioProposalDraftAuthority,
  useStudioProposalReviewAuthority,
...
const StudioProjectPage: React.FC<{
  ...
  const { paidRecoveryQuotes, setPaidRecoveryQuotes, paidRecoveryStatusMessageKeys, setPaidRecoveryStatusMessageKeys } =
    useStudioPaidRecoveryProposalState(projectId);
  ...
  const directorToolOutcomeInterpreter = useStudioDirectorToolOutcomeInterpreter({
    projectId,
    project,
    proposalRefreshing,
    proposalErrorMessageKey,
  ...
  const proposalDraftAuthorityRef = useStudioProposalDraftAuthority(drafts.dirtyCount, activeRuleDraftDirtyCount);
  ...
  const decideReferences = useStudioReferenceRequestReview({
    project,
    projectId,
    beginReviewedAction,
    finishReviewedAction,
  ...
  const reviewGeneratedReferences = useStudioGeneratedReferenceReview({
    reviewedActionRef,
    projectRef,
    openReferenceFocus,
    setActionErrorMessageKey,
  ...
  const dismissHandoff = useStudioHandoffDismissal({
    projectRef,
    beginReviewedAction,
    finishReviewedAction,
    refetchReferences,
