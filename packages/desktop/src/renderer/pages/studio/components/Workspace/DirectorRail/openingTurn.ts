...
export const DIRECTOR_PRESET_RULES = [
  ...
  'you. Reading costs nothing and needs no permission: studio_get_project_status, read_storyboard, and',
  'studio_list_routes are always available. When diagnosing where the film is stuck, start with studio_get_project_status;',
