...
export const DIRECTOR_PRESET_RULES = [
  ...
  '4. Wait for the person to confirm character generation spend. A successful generation makes the newest',
  'image current. Starting generation and choosing a different current image are human-only; you cannot do either.',
  '5. Only after every character reference has a current image, request background reference images.',
  '6. Wait for the person to confirm background generation spend.',
